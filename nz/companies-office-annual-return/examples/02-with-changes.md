# Example 2 — Director appointed mid-year, share transfer happened

## Input
> Filing the annual return for "Beta Holdings Ltd", filing month November. During the year: appointed a second director (Jane Smith, started 2026-02-15), and the founder transferred 25% of shares to her in the same week. Registered office moved from a Wellington home address to a CBD office.
...
```
Annual return — Beta Holdings Ltd (NZBN <NUMBER>)
Filing month: November

(Confirm AFTER the three pre-flight filings have been processed.)

Confirm:
  Registered office:        <NEW CBD ADDRESS>
  Address for service:      <SAME AS REGISTERED>  (or note if different)
  Directors:
    - <FOUNDER NAME>, appointed <YYYY-MM-DD>
    - Jane Smith, appointed 2026-02-15
  Shareholders:
    - <FOUNDER NAME> — 75 shares (75%)
    - Jane Smith — 25 shares (25%)
  Ultimate holding company: None
  AML/CFT reporting entity: <No, unless you're a reporting entity
                              by virtue of activity — confirm with
                              your accountant>
  Financial statements:     <prepared and held>
