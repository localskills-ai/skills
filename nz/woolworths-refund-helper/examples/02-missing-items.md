# Example 2 — Charged for items that weren't delivered
...
This is a charged-but-not-delivered issue rather than a quality problem, so it's a straight refund for the affected items.
